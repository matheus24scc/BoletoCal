...
BoletoCal — Turn any Brazilian boleto into a calendar event (due date + value + reminder). Zero-config, WhatsApp-friendly.

- **Primary language / stack:** Unknown — fill in the primary language/stack
- **Default branch:** `main`
- **Repository:** https://github.com/matheus24scc/BoletoCal
