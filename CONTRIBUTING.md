...
If you find a bug, please [open an issue](https://github.com/matheus24scc/BoletoCal/issues/new/choose) with:
...
Have an idea? [Open a feature request](https://github.com/matheus24scc/BoletoCal/issues/new/choose) describing the problem you want to solve and your proposed solution.

### Submitting Changes

1. **Fork** the repository and **clone** your fork:
   ```bash
   git clone https://github.com/<your-username>/BoletoCal.git
   cd BoletoCal
   ```
